...
#Region " Control "
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using B As New SolidBrush(ETC)
            ...
            If Bold Then
                G.DrawString(Text, GlobalFont(FontStyle.Bold, 12), B, New Point(32, 4))
            Else
                G.DrawString(Text, GlobalFont(FontStyle.Regular, 12), B, New Point(32, 4))
            End If
    ...
    Protected Overrides Sub OnMouseUp(e As MouseEventArgs)
        ...
        If Enabled Then
            ...
            'DirectCast(C, FirefoxRadioButton).Checked = True
            'End If
            'Next
...
#Region " Properties "
    ...
    Public Shadows Property Enabled_ As Boolean
        Get
            Return EnabledCalc
        End Get
        Set(value As Boolean)
...
#Region " Control "
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        CenterString(G, Text, GlobalFont(FontStyle.Regular, 11), ETC, FullRectangle(Size, False))
...
Public Class FirefoxSubTabControl
    Inherits TabControl
...
Public Class FirefoxMainTabControl
    Inherits TabControl
...
#Region " Control "
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        For i As Integer = 0 To TabPages.Count - 1
            ...
            Using B As New SolidBrush(FC)
                G.DrawString(TabPages(i).Text, GlobalFont(FontStyle.Bold, 14), B, New Point(TabRect.X + 15, TabRect.Y + 12))
            End Using
...
#Region " Properties "
    ...
    Public Property Enabled_ As Boolean
        Get
            Return EnabledCalc
        End Get
        Set(value As Boolean)
